          ...
          <div class="row">
            <div class="col-xs-12">
              <div class="box">
                ...
                <!-- form start -->
                <?php echo form_open_multipart('surat_masuk/edit');?>
                  <div class="box-body">
                  ...
                  <div class="form-group">
                     ...
                     <label for="">Kategori</label>
                      ...
                      <label for="">Tanggal Masuk</label>
                        <input type="date" class="form-control" value="<?php echo $record['tgl_masuk']?>"  name="tgl_masuk"  required>
                    </div>

                     <div class="form-group">
                      <label for="">Alamat Pengirim</label>
                        <textarea style="height:100px"  class="form-control"  name="alamat_pengirim" placeholder="Masukan alamat"><?php echo $record['alamat_pengirim']?></textarea>                
                    </div>
                    ...
                    <div class="form-group">
                      <label for="">Disposisi</label>
                        <input type="text" class="form-control"  name="disposisi" placeholder="Masukan alamat"><?php echo $record['disposisi']?></textarea>                
                    </div>

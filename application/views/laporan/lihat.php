          ...
          <div class="row">
            ...
            <div class="col-xs-12">
              <div class="box">
                ...
                <i class="fa fa-stethoscope"></i>
                  <h3 class="box-title">Cetak Data Surat Masuk</h3>
                </div><!-- /.box-header -->
                <div class="box-body">
                <div class="box box-primary">
                    <table border="0">
                        <tr><td width="500">
                  <?php echo form_open_multipart('laporan/cetak');?>
                  <table class="table table-condensed" border='0' width="200px">
                    <tr>
                        <td width="10">TANGGAL AWAL</td>
                        <td width="5">:</td>
                        <td width="10">
                            <input type="date" class="form-control"  name="tgl_awal" placeholder="Isikan tanggal Masuk" required>
                        </td>
                    </tr>
                    <tr>
                        <td >TANGGAL AKHIR</td>
                        <td>:</td>
                        <td>
                            <input type="date" class="form-control"  name="tgl_akhir" placeholder="Isikan tanggal Masuk" required>
                        </td>
                    </tr>
                    </table>
            ...
            <div class="col-xs-12">
              <div class="box">
                <div class="box-header">
                <i class="fa fa-stethoscope"></i>
                  <h3 class="box-title">Cetak Data Surat Masuk per Bulan</h3>
                </div><!-- /.box-header -->
                <div class="box-body">
                <div class="box box-primary">
                    <table border="0">

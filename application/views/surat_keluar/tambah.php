          ...
          <div class="row">
            <div class="col-xs-12">
              <div class="box">
                ...
                <!-- form start -->
                <?php echo form_open_multipart('surat_keluar/tambah');?>
                  <div class="box-body">
                    ...
                    <div class="form-group">
                      <label for="">Tanggal Keluar</label>
                        <input type="date" class="form-control"  name="tgl_keluar" placeholder="Isikan tanggal Masuk" required>
                    </div>

                      <div class="form-group">
                      <label for="">Alamat</label>
                        <textarea style="height:100px"  class="form-control" name="alamat_penerima" placeholder="Masukan alamat"></textarea>                
                    </div>
